/**
* @file Interface Generator 
* @summary 
* @copyright CommodityStream LLC 
* @license Apache-2.0
*/
...
function createInterface(name) {
    ...
    fs.readFile('./build/abi/' + name + '.json', 'utf8', function (err, data) {
        ...
        let header = [];
        let contracts = [];
        header.push("/// SPDX-License-Identifier: Apache-2.0");
        header.push("/// @version 2021-04 ");
        ...
        for (let i in contracts) {
            ...
            if (contracts[i] == "ITradingPair") {
                header.push('import "./ITradingPair.sol";');
            }
        }
...
createInterface("TradingPair");
createInterface("Twist");
